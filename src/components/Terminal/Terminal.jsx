...
function Terminal() {
  const handleCopy = () => {
    const cmdText = "Troi te ha hackeado "
        ...
        <div className="wrap">
          <div className="terminal">
            <hgroup className="head">
              ...
              <button className="copy_toggle" tabIndex={-1} type="button" onClick={handleCopy}>
                <svg width="16px" height="16px" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" strokeLinejoin="round" strokeLinecap="round" strokeWidth={2} stroke="currentColor" fill="none">
            ...
            <div className="body">
              <pre className="pre">
                ...
                {"\n"}
                {"          "}
                <code className="cmd" data-cmd="Troi te ha hackeado " />
                {"\n"}
                {"        "}
              </pre>
            </div>
